...
from .ernie_ai_studio_provider import ErnieAIStudioVisionProvider, ErnieAIStudioTextProvider
...
def register_all_providers():
    ...
    LLMServiceManager.register_vision_provider('ernie_ai_studio', ErnieAIStudioVisionProvider)
    ...
    LLMServiceManager.register_text_provider('ernie_ai_studio', ErnieAIStudioTextProvider)
...
__all__ = [
    ...
    'ErnieAIStudioVisionProvider',
    'ErnieAIStudioTextProvider'
]
